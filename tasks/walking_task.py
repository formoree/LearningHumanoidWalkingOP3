...
class WalkingTask(object):
    ...
    def calc_reward(self, prev_torque, prev_action, action):
        ...
        reward = dict(foot_frc_score=0.150 * rewards._calc_foot_frc_clock_reward(self, l_frc, r_frc),
                      ...
                      height_error=0.050 * rewards._calc_height_reward(self), # 0.0050
                      com_vel_error=0.200 * rewards._calc_fwd_vel_reward(self),# 0.200
                      torque_penalty=0.050 * rewards._calc_torque_reward(self, prev_torque), # 0.0050
                      action_penalty=0.050 * rewards._calc_action_reward(self, prev_action), #之前并没注释
        )
        return reward
